...
class Criadouro
{
	...
	//construtor de Criadouro
	function Criadouro($nome = null, $endereco = null, $cidade = null, $estado = null, $telefone1 = null, $telefone2 = null, $email = null, $contato = null, $id = null)
	{
		$this->set_nome($nome);
	...
	function insere()
	{
		$sql = "insert into criadouro values ('', '".$this->get_nome()."', '".$this->get_endereco()."', '".$this->get_cidade()."', '".$this->get_estado()."', '".$this->get_telefone1()."', '".$this->get_telefone2()."', '".$this->get_email()."', '".$this->get_contato()."')";
		$this->bd->executa($sql);
	}

	function altera()
	{
		$sql = "update criadouro set nome = '".$this->get_nome()."', endereco = '".$this->get_endereco()."', cidade = '".$this->get_cidade()."', estado = '".$this->get_estado()."', telefone1 = '".$this->get_telefone1()."', telefone2 = '".$this->get_telefone2()."', email = '".$this->get_email()."', contato = '".$this->get_contato()."' where id = '".$this->get_id()."'";
		$this->bd->executa($sql);
	}

	function lista()
	{
		$sql = "select * from criadouro";
		...
		while ($l = $this->bd->lista())
			$objs[] = new Criadouro($l['nome'], $l['endereco'], $l['cidade'], $l['estado'], $l['telefone1'], $l['telefone2'], $l['email'], $l['contato'], $l['id']);
		return $objs;
	}

	function seleciona()
	{
		$sql = "select * from criadouro where id = '".$this->get_id()."'";
		...
		$this->set_contato($this->bd->resultado(0, "contato"));
